                        ...
                        case DrawType.DrawText1:
                            {
                                ...
                                p2 = new Com.Api.MyZpSDK.Printer.DrawText1Parameters(ZpSDK)
                                {
                                    ...
                                    TextX = p1.TextX,
                                    TextY = p1.TextY,
                                    FontSize = Com.Api.MyZpSDK.PrinterCore.TextFont.ValueOf(p1.FontSize.ToString()),
                                    Rotate = Com.Api.MyZpSDK.PrinterCore.TextRotate.ValueOf(p1.Rotate.ToString()),
                                    Bold = p1.Bold,
                                    Reverse = p1.Reverse,
                        ...
                        case DrawType.DrawBarCode:
                            {
                                ...
                                p2 = new Com.Api.MyZpSDK.Printer.DrawBarCodeParameters(ZpSDK)
                                {
                                    ...
                                    StartY = p1.StartY,
                                    Text = p1.Text,
                                    Type = Com.Api.MyZpSDK.PrinterCore.BarCodeType.ValueOf(p1.Type.ToString()),
                                    Height = p1.Height,
                                    LineWidth = p1.LineWidth,
                                    Rotate = p1.Rotate,
                                };
                        ...
                        case DrawType.DrawGraphic:
                            {
                                ...
                                p2 = new Com.Api.MyZpSDK.Printer.DrawGraphicParameters(ZpSDK)
                                {
                                    ...
                                    DitheringType = Com.Api.MyZpSDK.PrinterCore.DitheringType.ValueOf(p1.DitheringType.ToString()),
                                    Rotate = p1.Rotate,
                                    StartX = p1.StartX,
                                    StartY = p1.StartY,
