...
public class Printer
{
    ...
    public static Dictionary<string, string> GetDevices(string Device, string DeviceRegexStr)
    {
        ...
        if (Build.VERSION.SdkInt > BuildVersionCodes.R && OperatingSystem.IsAndroidVersionAtLeast(31) && AndroidX.Core.Content.ContextCompat.CheckSelfPermission(Platform.AppContext, Manifest.Permission.BluetoothConnect) != Permission.Granted)
        {
